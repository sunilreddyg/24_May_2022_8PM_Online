...
public class SwitchTo_Frame {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//switching to frame using WebElement reference..
		WebElement FrameElement=driver.findElement(By.xpath("//iframe[@src='/signinstatic/tripidlogin.shtml?popup=no&guest=true']"));
